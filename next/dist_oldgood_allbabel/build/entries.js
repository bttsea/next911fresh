...
function createEntrypoints(pages, target, buildId, config) {
  ...
  Object.keys(pages).forEach(page => {
    ...
    if (isApiRoute && isLikeServerless) {
      ...
      server[(0, _path.join)('pages', bundleFile)] = `next-serverless-loader?${(0, _querystring.stringify)(serverlessLoaderOptions)}!`;
    ...
    if (!isApiRoute) {
      client[bundlePath] = `next-client-pages-loader?${(0, _querystring.stringify)({
        page,
        absolutePagePath
      })}!`;
    }
