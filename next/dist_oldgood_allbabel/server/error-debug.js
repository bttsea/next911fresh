...
function ErrorDebug({
  ...
  })), /*#__PURE__*/_react.default.createElement(StackTrace, {
    error: error,
    info: info
  }));
}
...
}, message || name), /*#__PURE__*/_react.default.createElement("pre", {
  style: styles.stack
}, stack), info && /*#__PURE__*/_react.default.createElement("pre", {
  style: styles.stack
}, info.componentStack));
