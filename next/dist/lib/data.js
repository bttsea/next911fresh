...
function createHook(fetcher, options) {
  ...
  return function useData(...args) {
    const router = (0, _react.useContext)(_routerContext.RouterContext);
    const dataManager = (0, _react.useContext)(_dataManagerContext.DataManagerContext);
    ...
    if (typeof window !== 'undefined') {
      const res = (0, _unfetch.default)(router.route + '?' + (0, _querystring.stringify)(router.query), {
        headers: {
